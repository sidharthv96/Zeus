    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="zeusApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="zeusApp.country.home.createLabel">Create a new Country</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {countryList && countryList.length > 0 ? (
            <Table responsive aria-describedby="country-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="zeusApp.country.countryName">Country Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="zeusApp.country.region">Region</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="zeusApp.country.home.notFound">No Countries found</Translate>
            </div>
          )}
        </div>
      </div>
