    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="zeusApp.employee.home.createOrEditLabel">
              <Translate contentKey="zeusApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="salaryLabel" for="employee-salary">
                    <Translate contentKey="zeusApp.employee.salary">Salary</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="commissionPctLabel" for="employee-commissionPct">
                    <Translate contentKey="zeusApp.employee.commissionPct">Commission Pct</Translate>
                  </Label>
                  <AvField id="employee-commissionPct" type="string" className="form-control" name="commissionPct" />
                </AvGroup>
                <AvGroup>
                  <Label for="employee-department">
                    <Translate contentKey="zeusApp.employee.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-manager">
                    <Translate contentKey="zeusApp.employee.manager">Manager</Translate>
                  </Label>
