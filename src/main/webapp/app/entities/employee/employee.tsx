    ...
    return (
      <div>
        <h2 id="employee-heading">
          <Translate contentKey="zeusApp.employee.home.title">Employees</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="zeusApp.employee.home.createLabel">Create a new Employee</Translate>
          </Link>
        </h2>
          ...
          >
            {employeeList && employeeList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('firstName')}>
                      <Translate contentKey="zeusApp.employee.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('lastName')}>
                      <Translate contentKey="zeusApp.employee.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('email')}>
                      <Translate contentKey="zeusApp.employee.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('phoneNumber')}>
                      <Translate contentKey="zeusApp.employee.phoneNumber">Phone Number</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('hireDate')}>
                      <Translate contentKey="zeusApp.employee.hireDate">Hire Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('salary')}>
                      <Translate contentKey="zeusApp.employee.salary">Salary</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('commissionPct')}>
                      <Translate contentKey="zeusApp.employee.commissionPct">Commission Pct</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="zeusApp.employee.department">Department</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="zeusApp.employee.manager">Manager</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="zeusApp.employee.home.notFound">No Employees found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
