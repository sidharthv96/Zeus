    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="zeusApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="zeusApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="job-history-startDate">
                    <Translate contentKey="zeusApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="job-history-endDate">
                    <Translate contentKey="zeusApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel" for="job-history-language">
                    <Translate contentKey="zeusApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">{translate('zeusApp.Language.FRENCH')}</option>
                    <option value="ENGLISH">{translate('zeusApp.Language.ENGLISH')}</option>
                    <option value="SPANISH">{translate('zeusApp.Language.SPANISH')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job-history-job">
                    <Translate contentKey="zeusApp.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-department">
                    <Translate contentKey="zeusApp.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-employee">
                    <Translate contentKey="zeusApp.jobHistory.employee">Employee</Translate>
                  </Label>
